...
class CuisinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuisine" do
    assert_difference('Cuisine.count') do
      post cuisines_url, params: { cuisine: { image: @cuisine.image, title: @cuisine.title } }
    end
  ...
  test "should update cuisine" do
    patch cuisine_url(@cuisine), params: { cuisine: { image: @cuisine.image, title: @cuisine.title } }
